\begin{thebibliography}{2}
	...
	\bibitem{play} Framework Play : \url{http://www.playframework.org}
	\bibitem{proginscala} Programming in Scala : \url{http://www.artima.com/shop/programming_in_scala_2ed}
	...
	\bibitem{jenkins} Apache Jenkins : \url{http://jenkins-ci.org/}
	\bibitem{perfplugin} Jenkins Performance Plugin : \url{https://wiki.jenkins-ci.org/display/JENKINS/Performance+Plugin}
	\bibitem{stapler} Stapler : \url{http://stapler.kohsuke.org/}
	\bibitem{jelly} Apache Jelly : \url{http://commons.apache.org/jelly/}
	\bibitem{jqplot} jqPlot : \url{http://www.jqplot.com/}
	\bibitem{gatlingplugin} Gatling Jenins Plugin : \url{https://github.com/excilys/gatling-jenkins-plugin}
\end{thebibliography}
